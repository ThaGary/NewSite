        ...
        <>
                <div id='links'>
                    <nav className="nav flex-column">
                        ...
                        <div onClick={props.handleClick} className="nav-link text-dark" target="_blank" rel="noopener noreferrer" ><i className="fas fa-2x orange fa-file-code" ></i> Projects</div>
                    </nav>
                </div>  
        </>
    )
